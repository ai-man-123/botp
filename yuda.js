...
nocache('./OkimiShizu.js', module => console.log(color('|TRM|'), color(`${module} Updated!`, 'cyan')))
    ...
    //SERAH LU MAU GANTI KYK MANA
        denz.on('group-participants-update', async (anu) => {
           mem = anu.participants[0]
			...
			fkontakk = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(anu.jid ? { remoteJid: '6283136505591-1604595598@g.us' } : {})}, message: { "contactMessage":{"displayName": `${mdata.subject}`,"vcard":`BEGIN:VCARD\nVERSION:3.0\nN:2;Nanda Style;;;\nFN:Nanda Style\nitem1.TEL;waid=6283145831517:6283145831517\nitem1.X-ABLabel:Mobile\nEND:VCARD` }}}
...
console.log(color(figlet.textSync(`${settings.NamaBot}`, {
	    ...
	    }), 'lightgreen')), term.slowTyping(' Created By Aiman' ,{ flashStyle: term.brightWhite })
